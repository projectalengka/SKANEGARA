          ...
          <div className="max-w-3xl">
            <article className="flex flex-col gap-12">
              ...
              <section>
                ...
                <div className="mt-5 flex flex-col gap-4 text-[var(--color-text-muted)]">
                  <p>
                    {/* This used to claim "Tanggal pembaruan terakhir tercatat pada
                        bagian atas halaman" — but the page hero renders an index
                        number and a standfirst, and no date. A privacy policy
                        that points at a date that does not exist is the kind of
                        detail that makes a reader distrust the rest of it. */}
                    Jika kebijakan ini berubah, kami akan memperbarui halaman ini agar selalu
                    mencerminkan perilaku situs yang sebenarnya.
                  </p>
                </div>
              </section>
            </article>
